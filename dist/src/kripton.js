...
exports.default = kripton;
function kripton(str) {
	var translation = str;

	// Si la palabra original es un palíndromo ninguna regla
	// anterior cuenta y se devuelve la misma palabra intercalando
